(function() {
    ...
    var parseBlock = require('./parse.block');
    ...
    Jouvence.prototype.testMode = function() {
        // in test mode, we add to the instance the 
        // private method we want to test
        // in unit tests
    ...
    function processLine(context, line) {
        ...
        // notes or comments
        var state = parseBlock(context.preprocessContext, line, context.lineno);
        if (state === 0) {
