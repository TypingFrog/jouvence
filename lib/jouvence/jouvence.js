(function() {
    ...
    function inDialogueContext(context) {
        return (context.lastElementNature === "character") ||
     ...
     */
    Jouvence.prototype.parse = function(input, notif) {
        var countData = 0;
        var eolMatcher = /\r?\n/;
        var pendingInput = '';
        var self = this;
    ...
    function doNotification(context, notif, debug) {
        ...
        // define the callbacks which are optional
        var hasNotifBlock = hasCallback("block");
        var hasNotifSynopsis = hasCallback("synopsis");
        var hasNotifSection = hasCallback("section");

        function hasCallback(cbName) {
            return (typeof(notif[cbName]) === "function");
        }
