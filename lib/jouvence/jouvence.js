(function() {
    ...
    function processLine(context, line) {
        ...
        if (typeof context.line1 !== "undefined") {
            ...
            while (!lineParsed) {
                lineParsed = parseLine(context, context.line0.line, context.line0.blocks);
            }
    ...
    // again
    function parseLine(context, line, blocks) {
        ...
        if (context.state === 0) {
            ...
            if (!currentLineBlank) {
                ...
                if (result && (result.before.trim().length === 0) && (result.after.trim().length === 0)) {
                    ...
                    // on te size of the preceding string and 1 for the '>'
